			...
			>
				...
				<Divider className={classes.divider}/>
					<List>
						...
						<ListItem button component="a" href="portfolio" key="Portfolio" className={classes.itemList}>
						...
						<ListItem button component="a" href="stocks/TSLA" key="stock" className={classes.itemList}>
